import { Box, FormHelperText, TextField, Typography ,FormControl, TextareaAutosize, Stack, Select, MenuItem, Button} from '@pankod/refine-mui'
...
const Form = ({type , register , handleSubmit , handleImageChange , formLoading , onFinishHandler,propertyImage} : FormProps) => {
  return (
    ...
    <Box mt={2.5} borderRadius='15px' padding='20px' bgcolor='#fcfcfc'>
      <form style={{ marginTop : '20px' , width : '100%', display:'flex' , flexDirection : 'column'}} onSubmit={handleSubmit(onFinishHandler)}>
        <FormControl>

...
const PropertyDetails = () => {
  ...
  propertyDetails.creator?.forEach((element:any) => {
        ...
        <Box width="100%" flex={1} maxWidth={326} display="flex" flexDirection="column" gap="20px">
          ...
          >
            ...
            <Stack mt={2} justifyContent="center" alignItems="center" textAlign="center">
              <img
                src={checkImage(currentUser?.avatar) ? currentUser?.avatar : "https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/User-avatar.svg/2048px-User-avatar.svg.png"}
                alt="avatar"
                width={90}
                height={90}
